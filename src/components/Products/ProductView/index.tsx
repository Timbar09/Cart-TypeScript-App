...
const ProductView = () => {
  ...
  const img: string = getProductImage(sku || '');
  ...
  return (
    ...
    >
      {product ? (
        <div className="product relative rounded-lg">
          <div className="main flex flex-col gap-1 items-center max-w-80 sm:max-w-80 mx-auto bg-gray-50 border-2 border-gray-100 rounded-lg py-4 px-4 sm:px-8">
